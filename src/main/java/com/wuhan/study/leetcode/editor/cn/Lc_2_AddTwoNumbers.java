...
public class Lc_2_AddTwoNumbers {
    public static void main(String[] args) {
        ...
        ListNode l1 = ListNodeUtil.getLsitNode(new int[]{9, 9, 9, 9, 9, 9, 9});
        ListNode l2 = ListNodeUtil.getLsitNode(new int[]{9, 9, 9, 9});
        System.out.print("l1 :");
        ListNodeUtil.printListNode(l1);
        System.out.print("l2 :");
        ListNodeUtil.printListNode(l2);
        System.out.print("result :");
        ListNodeUtil.printListNode(solution.addTwoNumbers(l1, l2));
    }
    ...
    class Solution {
        ...
        public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
            ...
            while (null != l1 || null != l2) {
                ...
                carry = sum / 10;//carry = Math.floor(sum / 10);
